...
- [ ] 🚦 3.1f Failing test: `Tyto::FileStorage::MAX_SIZE_BYTES` constant exists and equals `10 * 1024 * 1024` (R-P7). File: `backend_app/spec/infrastructure/file_storage/limits_spec.rb`. **red: 3F (1 failure + 2 errors), total 1270 — 2026-04-26**
