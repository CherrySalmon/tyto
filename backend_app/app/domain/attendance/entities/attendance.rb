...
require_relative '../../shared/values/geo_location'
require_relative '../../shared/values/null_geo_location'
    ...
    module Attendance
      module Entities
        ...
        class Attendance < Dry::Struct
          ...
          # @param event_location [Domain::Courses::Entities::Location] the event's location
