...
describe Tyto::Service::Assignments::UnpublishAssignment do
  ...
  describe '#call' do
    it 'unpublishes a published assignment and returns Success' do
      assignment = Tyto::Assignment.create(
        course_id: course.id, title: 'Published HW', status: 'published', allow_late_resubmit: false
      )

      result = Tyto::Service::Assignments::UnpublishAssignment.new.call(
    ...
    it 'returns Failure when unpublishing a draft assignment' do
      assignment = Tyto::Assignment.create(
    ...
    it 'returns Failure when unpublishing a disabled assignment' do
      assignment = Tyto::Assignment.create(
    ...
    it 'returns Failure when student tries to unpublish' do
      assignment = Tyto::Assignment.create(
