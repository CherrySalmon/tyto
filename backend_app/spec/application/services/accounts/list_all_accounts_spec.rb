...
describe Todo::Service::Accounts::ListAllAccounts do
  ...
  describe '#call' do
    it 'returns Success with all accounts for admin' do
      ...
      Todo::Account.create(email: 'user1@example.com', name: 'User 1')
      Todo::Account.create(email: 'user2@example.com', name: 'User 2')

      result = Todo::Service::Accounts::ListAllAccounts.new.call(requestor:)
